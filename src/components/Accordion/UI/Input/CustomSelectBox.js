...
function SearchIcon({color}) {
    return(
        <svg style={{margin:'-11px 0 0 0'}}  width="18" height="18" viewBox="0 0 18 18" fill="none" 
        ...
        4.23157 2.47656 6.72157Z" fill={color}/>
        </svg>
    )
}
...
function CancelIcon() {
    return(
        <svg style={{ margin: '-9px 0px 0px -4px'}} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path 
            fillRule="evenodd" 
            clipRule="evenodd" 
...
function CustomSelectBox({onChange, onClear=()=>null, value='', placeholder='Search'}) {
    ...
    return (
        <Wrapper>
            {position === 'left' && <IconWrapper position="left">
