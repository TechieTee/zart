...
import CustomSelectBox from '../../../UI/Input/CustomSelectBox'
...
export default function GlobalSearch({
  ...
  placeholder
    ...
    let placeholderText = placeholder ? placeholder :`Search`;
    ...
    return (
      <div style={boxWidth && inlineStyle} className={styleType}>
        <CustomSelectBox 
              value={value || ""}
